...
(function () {
  ...
  function renderRoute() {
    var html = '<h1>Нитка маршрута «Дорогами славы»</h1>' +
      "<p class=\"lead\">" + THEME.tagline + ". " + THEME.freedOn + ". Кольцо от Мостов через Княжеводцы, Ковшово, Лунно, Мальковичи, Гудевичи и Дубно.</p>" +
      '<ol class="route-list">';
  ...
  function renderLogistika() {
    ...
    var html = '<h1>Логистика</h1>' +
      "<p class=\"lead\">Адреса и координаты всех точек маршрута. Кнопки открывают точку во внешней карте — от неё можно проложить маршрут от своего местоположения. Маршрут кольцевой: старт и финиш в Мостах, весь круг по району ≈ 120–140 км.</p>" +
